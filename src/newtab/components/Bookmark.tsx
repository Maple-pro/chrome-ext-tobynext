...
const Bookmark = (props: BookmarkProps): JSX.Element => {
    return (
        <div id="bookmark-container" className="w-full h-40 my-10 px-20 py-10 rounded-md border-1 border-solid border-[#DDDDF5] shadow-sm shadow-[#DDDDF5] flex flex-row items-center justify-between">
